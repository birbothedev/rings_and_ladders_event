        ...
        <div className="fixed inset-0 backdrop-blur-sm flex justify-center items-center z-110">
            <div className="w-2xl flex flex-col gap-2">
                ...
                <div className="bg-border/80 p-4 rounded-2xl flex flex-col gap-4">
                    <div className="py-4 px-4 pl-1 rounded-full text-3xl font-bold">Action Feed</div>
                    <div>
                        00d 00h 00m ago This is an example Action feed report<br />
                        00d 00h 00m ago This is an example Action feed report<br />
                        00d 00h 00m ago This is an example Action feed report<br />
                        00d 00h 00m ago This is an example Action feed report<br />
                        00d 00h 00m ago This is an example Action feed report<br />
    ...
    return (
        <>
            ...
            <div className="flex justify-between">
                <span className="text-xl ">ActionFeed</span>
                <button 
